...
/// Cloud Storage — IMPORT-ONLY, old-app parity. Android's own document
/// picker lists every installed storage provider app (Google Drive,
/// Dropbox, OneDrive, ...) plus this device, videos only. The picked file
/// is copied into the app with a live progress bar; cloud imports can then
/// be kept permanently with "Save to device" (Movies/Max Player).
...
class _CloudStorageScreenState extends State<CloudStorageScreen> {
  ...
  /// The one action of this screen: open Android's picker, copy the chosen
  ...
  void _playPicked(String path, String name) {
    CrashLog.crumb('cloud.play', {'path': path});
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(
                    _importing ? 'Importing…' : 'Choose a video to import',
                    style: const TextStyle(
