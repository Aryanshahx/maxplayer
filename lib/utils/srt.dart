/// Pure SRT helpers for the AI subtitle pipeline (ported from the old app):
/// sidecar path naming, standards-compliant build/parse, sidecar pick,
/// music-caption filter and skip-intro/credits heuristics. All pure and
/// unit-tested (no `path` package — plain string ops keep it dependency-free).
library;
...
/// anything that wants to load the generated file.
...
/// HH:MM:SS,mmm" shape are skipped.
...
///
/// Ranking: exact `&lt;name&gt;.srt`/`&lt;name&gt;.vtt` first, then
/// language-suffixed `&lt;name&gt;.&lt;xx&gt;.srt`/`&lt;name&gt;.&lt;xx&gt;.vtt`
/// (alphabetical). The AI sidecar (`&lt;name&gt;.maxai.srt`) has its own
/// pipeline and is always excluded.
