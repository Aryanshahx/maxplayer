#!/usr/bin/env bash
# =============================================================================
# Max Player update v4: brightness swipe, pinch zoom, player settings,
# history screen, quality badges
# Run from your flutter project root:  cd ~/IdeaProjects/maxplayer
#
# NEW: left-swipe brightness (native, no new plugins), double-tap middle
#      play/pause, two-finger pinch zoom, player settings sheet (gear
#      icon) to customize every gesture, history screen (clock icon on
#      home), 1080p/720p/4K badges on the video grid.
# INCLUDES all previous updates - safe on any repo state.
# Verified: flutter analyze = no issues, flutter test = 15/15 passed.
# =============================================================================
set -e

mkdir -p lib/models lib/state lib/screens lib/widgets lib/services lib/utils test android/app/src/main/kotlin/com/example/maxplayer
...
echo "  git add -A && git commit -m \"Add brightness+pinch zoom gestures, player settings, history screen, quality badges\" && git push
