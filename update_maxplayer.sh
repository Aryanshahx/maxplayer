#!/usr/bin/env bash
# =============================================================================
# Max Player update: VLC-style display settings + native video thumbnails
# Run from your flutter project root, e.g.:  cd ~/IdeaProjects/maxplayer
#
# Adds: Display settings sheet (list/grid, favourites, grouping, playback
# action, sort-by with directions), real video thumbnails + durations via
# NATIVE Kotlin MediaMetadataRetriever (NO new dart dependencies),
# persistent favourites/settings via native SharedPreferences.
...
echo "  git add -A && git commit -m \"Add VLC-style display settings + native thumbnails\" && git push"
